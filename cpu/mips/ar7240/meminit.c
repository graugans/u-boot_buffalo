...
void
ar7240_ddr_initial_config_for_mtest(unsigned long tap_fixed)
{
	BUFFALO_MTEST_PARAM p;
	memcpy(&p, (volatile BUFFALO_MTEST_PARAM *)BUFFALO_MTEST_PARAM_ADDR, sizeof(p));

	printf("\nDDR config for MTEST mode...\n");

	buffalo_mtest_ddr_conf_dump(&p);



	ar7240_reg_wr_nf(AR7240_DDR_CONFIG, p.vAR7240_DDR_CONFIG);
	udelay(100);
	ar7240_reg_wr_nf(AR7240_DDR_CONFIG2, p.vAR7240_DDR_CONFIG2);
	udelay(100);
	ar7240_reg_wr_nf(AR7240_DDR_CONTROL, 0x8);
	udelay(10);
	ar7240_reg_wr_nf(AR7240_DDR_CONTROL, 0x1);
	udelay(10);
	ar7240_reg_wr_nf(AR7240_DDR_EXT_MODE, p.vAR7240_DDR_EXT_MODE);
	udelay(100);
	ar7240_reg_wr_nf(AR7240_DDR_CONTROL, 0x2);
	udelay(10);
	ar7240_reg_wr_nf(AR7240_DDR_CONTROL, 0x8);
	udelay(10);
	ar7240_reg_wr_nf(AR7240_DDR_MODE, p.vAR7240_DDR_MODE);
	udelay(100);
	ar7240_reg_wr_nf(AR7240_DDR_CONTROL, 0x1);
	udelay(10);
	ar7240_reg_wr_nf(AR7240_DDR_REFRESH, p.vAR7240_DDR_REFRESH);
	udelay(100);
	ar7240_reg_wr_nf(AR7240_DDR_RD_DATA_THIS_CYCLE, p.vAR7240_DDR_RD_DATA_THIS_CYCLE);
	udelay(100);

	if (tap_fixed) {
		ar7240_reg_wr(AR7240_DDR_TAP_CONTROL0, p.vAR7240_DDR_TAP_CONTROL0);
		udelay(10);
		ar7240_reg_wr(AR7240_DDR_TAP_CONTROL1, p.vAR7240_DDR_TAP_CONTROL1);
		udelay(10);
		ar7240_reg_wr(AR7240_DDR_TAP_CONTROL2, p.vAR7240_DDR_TAP_CONTROL2);
		udelay(10);
		ar7240_reg_wr(AR7240_DDR_TAP_CONTROL3, p.vAR7240_DDR_TAP_CONTROL3);
		udelay(10);
	}
}
...
#ifdef	CONFIG_BUFFALO
    ar7240_reg_wr_nf(AR7240_DDR_CONTROL, 0x4);
    udelay(10);
    ar7240_reg_wr_nf(AR7240_DDR_CONTROL, 0x4);
    udelay(10);
#endif	//CONFIG_BUFFALO
