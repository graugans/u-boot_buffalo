...
void	ar7240_pci_ar9283_led(int on)
{
	if (on)
		ar7240_reg_wr_nf(0x10004048, 0x00000);	//GPIO Output (active low)
	else
		ar7240_reg_wr_nf(0x10004048, 0x00002);	//GPIO Output
}

void	ar7240_pci_ar9283_gpio_init()
{
    uint32_t cmd;
	...
	ar7240_reg_wr_nf(0x10004054, 0x20000);	//GPIO I/O (Disable JTAG)
	udelay(100);
	ar7240_reg_wr_nf(0x1000404C, 0x00004);	//GPIO Output Enable
	udelay(100);
	ar7240_reg_wr_nf(0x10004048, 0x00000);	//GPIO Output
	udelay(100);
	ar7240_reg_wr_nf(0x10004088, 0x55555);	//GPIO pullup / pulldown
	udelay(100);

	ar7240_pci_ar9283_led(1);
}
#endif	//CONFIG_BUFFALO
